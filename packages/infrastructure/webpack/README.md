...
**webpack.config.js**
```javascript
module.exports = require("@meniscus/webpack").configForNode;
```
### React package
...
**webpack.config.js**
```javascript
module.exports = require("@meniscus/webpack").configForReact;
```
...
module.exports = require("@meniscus/webpack").getMultiExportConfig(packageJson);
```
