...
```javascript
module.exports = require("@meniscus/jest").monorepoPackageConfig(__dirname).configForNode;
```
...
**./jest.config.js**
```javascript
module.exports = require("@meniscus/jest").monorepoRootConfig(__dirname);
```
