...
import type { BaseWindow, KeyboardEvent, MenuItemConstructorOptions, MenuItem as ElectronMenuItem } from "electron";
...
import type { Orderable } from "@meniscus/utilities";
...
export interface ElectronClickable {
  ...
  onClick: (menuItem: ElectronMenuItem, browserWindow: (BaseWindow) | (undefined), event: KeyboardEvent) => void;
}
