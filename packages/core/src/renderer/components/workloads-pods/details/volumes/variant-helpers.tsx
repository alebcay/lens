...
import type { PodVolumeVariants, Pod, SecretReference, LocalObjectReference } from "@meniscus/kube-object";
import type { KubeApiQueryParams, ResourceDescriptor } from "@meniscus/kube-api";
